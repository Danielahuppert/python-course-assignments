...
class PixelsToMMGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Pixel Area to mm² Converter")
        ...
        self.pixel_entry = ttk.Entry(main_frame, font=("Arial", 12), width=15)
        ...
        self.norm_entry = ttk.Entry(main_frame, font=("Arial", 12), width=15)
