...
class circleAreaGUI:
    def __init__(self, root):
        ...
        # use tk.Label for custom background/foreground support
        self.result_label = tk.Label(main_frame, text="", font=("Arial", 12),
                                     fg="blue", bg="lightgray", relief="sunken", padx=5, pady=5)
    ...
    def calculate_area(self):
        ...
        try:
            ...
            if not radius_str:
                messagebox.showerror("Error", "Please enter the radius.")
                return
            ...
            if radius < 0:
                messagebox.showerror("Error", "Radius must be non-negative.")
                return
